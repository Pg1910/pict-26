...
# PROCESSING PIPELINE
# =========================================================
def process_transactions(df, simulation_mode=True):
    ...
    def build_reasons(row):
        ...
        if simulation_mode and row["risk_velocity_sim"]:
...
required_cols = {
    ...
    "device_hash", "ip_address", "location"
}
...
with st.spinner("Processing transactions..."):
    try:
        data = process_transactions(raw_df, simulation_mode)
